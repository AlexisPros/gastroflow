...
RESERVATION_ROLES = {ADMIN, MANAGER, WAITER, KITCHEN, CHEF, BARTENDER, WYDAWKA}
FISCAL_ROLES = {ADMIN, MANAGER, WAITER}
KITCHEN_ROLES = {ADMIN, MANAGER, KITCHEN, CHEF, BARTENDER, WYDAWKA}
STOCK_ROLES = {ADMIN, MANAGER, KITCHEN, CHEF, BARTENDER, WYDAWKA}
FLOOR_PLAN_ROLES = {ADMIN, MANAGER}
STAFF_ROLES = {ADMIN, MANAGER, WAITER, KITCHEN, CHEF, BARTENDER, WYDAWKA}
