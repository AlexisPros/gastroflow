...
class WarehouseDocumentItem(Base):
    ...
    book_quantity: Mapped[Decimal | None] = mapped_column(Numeric(14, 3), nullable=True)
    ...
    difference_value: Mapped[Decimal | None] = mapped_column(Numeric(12, 2), nullable=True)
